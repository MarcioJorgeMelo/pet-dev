      ...
      <div className="container mx-auto px-4">
        <div>
          ...
          <div className="relative">
            ...
            <button
              onClick={scrollNext}
              className="bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 cursor-pointer absolute -right-7 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
            >
